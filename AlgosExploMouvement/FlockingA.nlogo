...
to setup
  ...
  crt population
    [
      ifelse random 2 = 1 [set color blue] [set color green]
...
to avoid-others
  set others turtles in-cone vision angle-avoidance with [color != [color] of myself] 
  if any? others
  [
    set nearest-other min-one-of others [distance myself]
