...
to-report vectObstacles
  ...
  ifelse (nearest-obstacles = nobody)
  [set ob VectFromAngle heading 0]
  [set ob VectFromAngle (towards nearest-obstacles + 180) (1 / distance nearest-obstacles)]
  report ob
end
