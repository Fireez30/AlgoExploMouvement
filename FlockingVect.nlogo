...
to vect-flock
  ...
  if any? flockmates
  [
   let p multiplyScalarvect pondAlign vectAlign
   let x multiplyScalarvect pondSeparate vectSeparate
   let y multiplyScalarvect pondCohere vectCohere
  
   let v1 additionvect x y
   let v2 additionvect p v1
   
   turn-towards angleFromVect v2 max-align-turn]
end
